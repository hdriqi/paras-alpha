  ...
  return (
    <div className="flex h-12 w-full bg-white" style={{
      ...
      <Link href="/hub/following">
        <div className={`w-1/5 flex items-center justify-center relative ${isActive(router.pathname, '/hub/following') ? `text-black-1` : `text-black-3`}`}>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {
            isActive(router.pathname, '/hub/following') && (
              <div className="absolute bottom-0 p-1">
                <svg width="4" height="4" viewBox="0 0 4 4" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <circle cx="2" cy="2" r="2" fill="#222222"/>
                </svg>
