              ...
              <div className="w-full h-full flex items-center justify-between">
                <div className="flex">
                  <svg width="52" height="36" viewBox="0 0 52 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M25.0488 1.46341V9.02439a8V1.45122L25.0488 1.46341ZM24.3049 8.12195L22.1341 2.62195a9.5732V3.42683H20.9634L19.0976 8.09756L19.8415 8.40244L20.4756 6.79268H22.9146L23.5732 8.41463L24.3049 8.12195ZM22.6098 6H20.7927L21.7073 3.71951L22.6098 6Z" fill="#191F2C"/>
                  ...
                  <Link href="/login">
                    <div className="flex items-center">
                      ...
                      <svg className="ml-1" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fillRule="evenodd" clipRule="evenodd" d="M10.5858 9.00001H2V7.00001a0.5858L7.29289 3.70712L8.70711 2.29291L14.4142 8.00001L8.70711 13.7071L7.29289 12.2929L10.5858 9.00001Z" fill="black"/>
                      </svg>
                    </div>
                  </Link>
                </div>
