...
const Distribute = ({ onClose, onSubmit }) => {
  useEffect(() => {
    disableBodyScroll(document.querySelector('#new-post-distribute'), {
      reserveScrollBarGap: true,
    })

    return () => {
      enableBodyScroll(document.querySelector('#new-post-distribute'))
    }
  }, [])
  ...
  return (
    <div id="new-post-distribute" className="fixed inset-0 z-30 min-h-screen overflow-y-auto">
      <Scrollbars
        renderThumbVertical={renderThumb}
      >
        <div className="max-w-sm m-auto bg-dark-0 ">
          <NavTop
            left={
