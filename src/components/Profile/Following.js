...
const Following = ({ followingList, hasMore, getFollowingList }) => {
  return (
    <div className="bg-dark-0 min-h-screen">
      <NavTop
        ...
        center={
          <h3 className="text-lg font-bold text-white px-2">Following</h3>
        }
        right={
        ...
        >
          {
            followingList.map((follow, idx) => {
              return (
                <div className="mt-6 mx-4" key={idx}>
